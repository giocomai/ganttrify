ui <- fluidPage(
  ...
  tags$style("h4 {font-family: 'Roboto', sans-serif; font-weight: bold; text-shadow: 3px 3px 3px #grey;text-decoration: underline;"),
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      shiny::HTML("<hr />"),
      shiny::sliderInput(inputId = "download_width",
                         ...
                         step = 1,
                         round = TRUE),
      shiny::sliderInput(inputId = "download_height",
