...
Given what is evidently my posh taste for Gantt charts, I had no other option than making this package with a pretentious, gentrified name, rather then the obvious "ganttr". 
...
```{r echo=FALSE}
df <- tibble::tribble(~wp, ~activity, ~start_month, ~end_month, 
