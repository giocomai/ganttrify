...
test_project_date_month <- tibble::tribble(
  ~wp, ~activity, ~start_date, ~end_date,
...
test_spots_date_month <- tibble::tribble(
  ~activity, ~spot_type, ~spot_date,
...
test_project_date_day <- tibble::tribble(
  ~wp, ~activity, ~start_date, ~end_date,
...
test_spots_date_day <- tibble::tribble(
  ~activity, ~spot_type, ~spot_date,
